...
#ifndef PATH_PLANNING_INCLUDE_CONSTANTS_H_
#define PATH_PLANNING_INCLUDE_CONSTANTS_H_
...
static const int bbSize = std::ceil(
		(sqrt(width * width + length * length) + 4) / cellSize);
...
#endif /* PATH_PLANNING_INCLUDE_CONSTANTS_H_ */

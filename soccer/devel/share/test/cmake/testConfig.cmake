...
if("TRUE" STREQUAL "TRUE")
  set(test_SOURCE_PREFIX /home/soccer/soccerbot/soccer/src/test)
  set(test_DEVEL_PREFIX /home/soccer/soccerbot/soccer/devel)
  set(test_INSTALL_PREFIX "")
  set(test_PREFIX ${test_DEVEL_PREFIX})
else()
  set(test_SOURCE_PREFIX "")
  set(test_DEVEL_PREFIX "")
  set(test_INSTALL_PREFIX /home/soccer/soccerbot/soccer/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'soccer <soccer@utra.ca>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'test' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/soccer/soccerbot/soccer/src/test/${idir}'.  Ask the maintainer 'soccer <soccer@utra.ca>' to fix it.")
    endif()

...
if("TRUE" STREQUAL "TRUE")
  set(gridmap_2d_SOURCE_PREFIX /home/vuwij/soccerbot/soccer/src/humanoid_navigation/gridmap_2d)
  set(gridmap_2d_DEVEL_PREFIX /home/vuwij/soccerbot/soccer/devel)
  ...
  set(gridmap_2d_INSTALL_PREFIX /home/vuwij/soccerbot/soccer/install)
...
if(NOT "/home/vuwij/soccerbot/soccer/src/humanoid_navigation/gridmap_2d/include " STREQUAL " ")
  set(gridmap_2d_INCLUDE_DIRS "")
  set(_include_dirs "/home/vuwij/soccerbot/soccer/src/humanoid_navigation/gridmap_2d/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'gridmap_2d' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Armin Hornung <HornungA@informatik.uni-freiburg.de>, Pramuditha Aravinda <aravindadp@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'gridmap_2d' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vuwij/soccerbot/soccer/src/humanoid_navigation/gridmap_2d/${idir}'.  Ask the maintainer 'Armin Hornung <HornungA@informatik.uni-freiburg.de>, Pramuditha Aravinda <aravindadp@gmail.com>' to fix it.")
    endif()
    _list_append_unique(gridmap_2d_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "gridmap_2d")

// Generated by gencpp from file nubot_common/Wrench.msg
// DO NOT EDIT!


#ifndef NUBOT_COMMON_MESSAGE_WRENCH_H
#define NUBOT_COMMON_MESSAGE_WRENCH_H
...
struct Wrench_
{
  ...
  typedef boost::shared_ptr< ::nubot_common::Wrench_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::nubot_common::Wrench_<ContainerAllocator> const> ConstPtr;

}; // struct Wrench_

typedef ::nubot_common::Wrench_<std::allocator<void> > Wrench;

typedef boost::shared_ptr< ::nubot_common::Wrench > WrenchPtr;
typedef boost::shared_ptr< ::nubot_common::Wrench const> WrenchConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::nubot_common::Wrench_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::nubot_common::Wrench_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::nubot_common::Wrench_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nubot_common::Wrench_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nubot_common::Wrench_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nubot_common::Wrench_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nubot_common::Wrench_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nubot_common::Wrench_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::nubot_common::Wrench_<ContainerAllocator> >
{
  ...
  static const char* value(const ::nubot_common::Wrench_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe37e6adf97eba509ULL;
  static const uint64_t static_value2 = 0x5baa77dffb71e5bdULL;
};

template<class ContainerAllocator>
struct DataType< ::nubot_common::Wrench_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::nubot_common::Wrench_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::nubot_common::Wrench_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::nubot_common::Wrench_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nubot_common::Wrench_<ContainerAllocator>& v)
  {
    s << indent << "body_name: ";
...
#endif // NUBOT_COMMON_MESSAGE_WRENCH_H

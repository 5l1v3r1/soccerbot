// Generated by gencpp from file nubot_common/temp.msg
// DO NOT EDIT!


#ifndef NUBOT_COMMON_MESSAGE_TEMP_H
#define NUBOT_COMMON_MESSAGE_TEMP_H
...
struct temp_
{
  ...
  typedef boost::shared_ptr< ::nubot_common::temp_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::nubot_common::temp_<ContainerAllocator> const> ConstPtr;

}; // struct temp_

typedef ::nubot_common::temp_<std::allocator<void> > temp;

typedef boost::shared_ptr< ::nubot_common::temp > tempPtr;
typedef boost::shared_ptr< ::nubot_common::temp const> tempConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::nubot_common::temp_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::nubot_common::temp_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::nubot_common::temp_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nubot_common::temp_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nubot_common::temp_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nubot_common::temp_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nubot_common::temp_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nubot_common::temp_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::nubot_common::temp_<ContainerAllocator> >
{
  ...
  static const char* value(const ::nubot_common::temp_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe37e6adf97eba509ULL;
  static const uint64_t static_value2 = 0x5baa77dffb71e5bdULL;
};

template<class ContainerAllocator>
struct DataType< ::nubot_common::temp_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::nubot_common::temp_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::nubot_common::temp_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::nubot_common::temp_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nubot_common::temp_<ContainerAllocator>& v)
  {
    s << indent << "body_name: ";
...
#endif // NUBOT_COMMON_MESSAGE_TEMP_H

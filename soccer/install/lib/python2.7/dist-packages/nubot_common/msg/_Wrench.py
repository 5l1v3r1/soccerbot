...
"""autogenerated by genpy from nubot_common/Wrench.msg. Do not edit."""
import sys
...
class Wrench(genpy.Message):
  ...
  _type = "nubot_common/Wrench"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string body_name                          # Gazebo body to apply wrench (linear force and torque)

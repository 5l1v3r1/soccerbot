...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nubot_common-msg:<Num> is deprecated: use nubot_common-msg:Num instead.")))

(cl:ensure-generic-function 'body_name-val :lambda-list '(m))
(cl:defmethod body_name-val ((m <Num>))
...
(cl:defmethod reference_frame-val ((m <Num>))
...
(cl:defmethod reference_point-val ((m <Num>))
...
(cl:defmethod start_time-val ((m <Num>))

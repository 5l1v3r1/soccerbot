...
(cl:defmethod cl:initialize-instance :after ((m <temp>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'temp)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nubot_common-msg:<temp> is deprecated: use nubot_common-msg:temp instead.")))

(cl:ensure-generic-function 'body_name-val :lambda-list '(m))
(cl:defmethod body_name-val ((m <temp>))
...
(cl:defmethod reference_frame-val ((m <temp>))
...
(cl:defmethod reference_point-val ((m <temp>))
...
(cl:defmethod wrench-val ((m <temp>))
...
(cl:defmethod start_time-val ((m <temp>))
...
(cl:defmethod duration-val ((m <temp>))
